...
//    SysTick_CLKSourceConfig(SysTick_CLKSource_HCLK);    // Changing the SysTick clk to HCLK
...
void delayMicroseconds(uint32_t us)
{
    ...
    reload = SysTick->LOAD;         // reload = SysTick->LOAD = 168000 (SystemCoreClock / configTICK_RATE_HZ)
    ticks = us * usTicks;           // ticks = us * 168, e.g. ticks = 1000 * 168 = 168000
    tOld = SysTick->VAL;
